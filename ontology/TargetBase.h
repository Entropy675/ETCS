#ifndef BASE_TARGET_H__
#define BASE_TARGET_H__
#include "Target.h"
...
// ResizableBase/DeletableBase itself) -- see Target.h's own comment for
...
// here is legal. Both Target_ and Resizable_ reach ETCS::Entity through
...
//
// A VulkanTarget therefore gets BOTH a "Target" and a "Resizable"
...
ETCS_SUPERTYPE_BASE(Target), public ResizableBase<Derived>
{
    ETCS_MAKE_INSTANCE(Target)
